...
if __name__ == "__main__":
    ...
    Val, Ntrucks = extra_trucks_solver("weekday_routesLOW.pkl", removed_store)
    print(Val)
    print(extra_trucks_solver("weekend_routesLOW.pkl", removed_store, weekend=True, Ntrucks = Ntrucks))
